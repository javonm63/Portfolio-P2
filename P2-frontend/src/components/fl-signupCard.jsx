...
function FlSignUp({openSignup, closeSignup}) {
    ...
    return (
        <form className='fl-signupCard-container' style={{display: openSignup ? 'flex' : 'none'}} onSubmit={submitSignup}>
            ...
            <input className='signup-inputs' type='text' placeholder='Company'required value={company} onChange={(e) => setCompany(e.target.value)}></input>
