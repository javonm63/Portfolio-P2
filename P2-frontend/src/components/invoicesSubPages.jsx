...
function InvSubPages({view, setShowNew, setShowDraft, setDraft, setLoad, dispItem, setDispItem, showPage, subPageInfo, subPageInfoText, infoText, display, display2, display4, display5, setDisplay4, setInv, Inv, sendTo, title1, title2, title3, title4}) {
