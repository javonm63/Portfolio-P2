...
function InvSubPages({setShowNew, setShowDraft, setDraft, setLoad, dispItem, setDispItem, showPage, subPageInfo, subPageInfoText, infoText, display, display2, display4, setDisplay4, setInv, Inv, sendTo}) {
