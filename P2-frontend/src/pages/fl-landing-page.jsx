...
function FlLandingPage() {
    ...
    return (
        <div className='landing-page-main-cont'>
            ...
            <LandingCard1 card1Title={'Simplify your invoicing'} card1Text={'An easy to use invoicing and billing software that connects freelancers and clients.'} card1Btn={'Sign Up'}/>
